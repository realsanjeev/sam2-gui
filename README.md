...
> **Quick Test**: Run the [Google Colab Notebook](https://colab.research.google.com/github/realsanjeev/sam2-gui/blob/main/notebooks/SAM2_1_for_video_tracking.ipynb) to tinker with SAM2 Video tracking.
